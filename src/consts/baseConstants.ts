...
export const aboutTeam = [
    { name: "Dr. João Silva", role: "Diretor Técnico", specialty: "Geofísica Aplicada" },
    { name: "Dra. Maria Santos", role: "Coordenadora", specialty: "Hidrogeologia" },
    { name: "Eng. Pedro Costa", role: "Gerente de Projetos", specialty: "Engenharia Civil" },
    { name: "Dr. Carlos Lima", role: "Especialista", specialty: "Geofísica Ambiental" },
];
