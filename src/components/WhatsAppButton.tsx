...
const WhatsAppButton = () => {
  ...
  const onSubmit = (data: FormData) => {
    const message = `Olá! Meu nome é ${data.name}. Gostaria de mais informações sobre os serviços da GeoView.`;
    const whatsappNumber = `55${phone}`; // Substituir pelo número real da empresa
